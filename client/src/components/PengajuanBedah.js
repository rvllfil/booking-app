...
const PengajuanBedah = ({datas, user}) => {
  ...
  return (
    <div>
      ...
      <p className='text-lg text-black'>{datas.keluhan}</p>
      <p className='mt-2 text-lg font-bold text-pink-400 '>Waktu</p>
      <p className='text-lg text-black'>{`Hari ${datas.hari} Pukul ${datas.waktu}`}</p>
